/**
 * MINI-CARTE — ARCHÉ
 * Trace cartographique silencieuse
 *
 * Même géométrie, ontologie différente
 * - Pas de nodes
 * - Pas de hover
 * - Pas d'animation
 * - Existe en marge, comme une annotation manuscrite
 */
    ...
    >
      ...
      >
        <g>
          ...
          {/* Central line — la Seine, simplified */}
          <polyline
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
